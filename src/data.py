...
def visualize_one_batch(data_loaders, max_n: int = 5):
    ...
    :return: None
    """
    # Directly iterate over the DataLoader
    for images, labels in data_loaders["train"]:
        ...
        # Convert from BGR to RGB and clip images
...
def test_data_loaders_output_type(data_loaders):
    ...
    for images, labels in data_loaders["train"]:
        ...
        assert images.shape[-1] == 224, "The tensors returned by your dataloaders should be 224x224. Did you forget to resize and/or crop?"
